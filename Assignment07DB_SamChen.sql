...
-- 2021-11-28,SamChen,Created File & Completed Q1-Q5
-- 2021-11-29,SamChen,Completed Q6-Q8
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_SamChen')
	 Begin 
	  Alter Database [Assignment07DB_SamChen] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_SamChen;
	 End
	Create Database Assignment07DB_SamChen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_SamChen;
...
CREATE VIEW vProductInventoriesWithPreviousMonthCounts AS
	SELECT TOP 10000
		...
		,CASE
			...
			ELSE LAG(InventoryCount) OVER(ORDER BY ProductName, MONTH(InventoryDate))
